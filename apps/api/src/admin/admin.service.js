...
var AdminService = function () {
    ...
    var AdminService = _classThis = /** @class */ (function () {
        ...
        AdminService_1.prototype.reports = function () {
            return this.prisma.report.findMany({ orderBy: { createdAt: 'desc' } });
        };
        AdminService_1.prototype.removePost = function (id) {
            return this.prisma.post.delete({ where: { id: id } });
        };
        AdminService_1.prototype.manageGroups = function () {
            return this.prisma.group.findMany({ include: { _count: { select: { members: true, posts: true } } } });
        };
        AdminService_1.prototype.verifyMember = function (userId, isVerified) {
            return this.prisma.user.update({ where: { id: userId }, data: { isVerified: isVerified } });
        };
