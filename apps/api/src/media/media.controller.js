...
var MediaController = function () {
    ...
    var MediaController = _classThis = /** @class */ (function () {
        ...
        MediaController_1.prototype.createUploadUrl = function (user, dto) {
            return this.mediaService.createUploadUrl(user.sub, dto);
        };
        MediaController_1.prototype.confirmUpload = function (user, dto) {
    ...
    (function () {
        ...
        _createUploadUrl_decorators = [(0, common_1.Post)('upload-url')];
        _confirmUpload_decorators = [(0, common_1.Post)('confirm')];
