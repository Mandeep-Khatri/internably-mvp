...
var MessagesController = function () {
    var _classDecorators = [(0, common_1.Controller)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var MessagesController = _classThis = /** @class */ (function () {
        function MessagesController_1(messagesService, messagesGateway) {
        ...
        MessagesController_1.prototype.conversations = function (user) {
            return this.messagesService.conversations(user.sub);
        };
        MessagesController_1.prototype.createConversation = function (user, body) {
            return this.messagesService.createConversation(user.sub, body.peerId);
        };
        MessagesController_1.prototype.messages = function (user, id) {
            return this.messagesService.messages(user.sub, id);
        };
        MessagesController_1.prototype.sendMessage = function (user, id, body) {
            return __awaiter(this, void 0, void 0, function () {
                var message;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.messagesService.sendMessage(user.sub, id, body.content)];
                        case 1:
                            message = _a.sent();
    ...
    (function () {
        ...
        _conversations_decorators = [(0, common_1.Get)('conversations')];
        ...
        _sendMessage_decorators = [(0, common_1.Post)('conversations/:id/messages')];
        __esDecorate(_classThis, null, _conversations_decorators, { kind: "method", name: "conversations", static: false, private: false, access: { has: function (obj) { return "conversations" in obj; }, get: function (obj) { return obj.conversations; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _createConversation_decorators, { kind: "method", name: "createConversation", static: false, private: false, access: { has: function (obj) { return "createConversation" in obj; }, get: function (obj) { return obj.createConversation; } }, metadata: _metadata }, null, _instanceExtraInitializers);
