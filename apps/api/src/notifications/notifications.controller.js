...
var NotificationsController = function () {
    ...
    var _registerPushToken_decorators;
    var _removePushToken_decorators;
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.list = function (user) {
            return this.notificationsService.list(user.sub);
        };
        NotificationsController_1.prototype.read = function (user, id) {
            return this.notificationsService.read(user.sub, id);
        };
        NotificationsController_1.prototype.readAll = function (user) {
            return this.notificationsService.readAll(user.sub);
        };
        NotificationsController_1.prototype.registerPushToken = function (user, dto) {
            return this.notificationsService.registerPushToken(user.sub, dto.token, dto.platform);
        };
        NotificationsController_1.prototype.removePushToken = function (user, dto) {
    ...
    (function () {
        ...
        _read_decorators = [(0, common_1.Patch)(':id/read')];
        _readAll_decorators = [(0, common_1.Patch)('read-all')];
        _registerPushToken_decorators = [(0, common_1.Post)('push-token')];
        _removePushToken_decorators = [(0, common_1.Delete)('push-token')];
        ...
        __esDecorate(_classThis, null, _registerPushToken_decorators, { kind: "method", name: "registerPushToken", static: false, private: false, access: { has: function (obj) { return "registerPushToken" in obj; }, get: function (obj) { return obj.registerPushToken; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _removePushToken_decorators, { kind: "method", name: "removePushToken", static: false, private: false, access: { has: function (obj) { return "removePushToken" in obj; }, get: function (obj) { return obj.removePushToken; } }, metadata: _metadata }, null, _instanceExtraInitializers);
